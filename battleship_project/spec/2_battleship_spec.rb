...
describe "Battleship" do
  ...
  describe "PART 3" do
    ...
    describe "#start_game" do
      ...
      it "should printt the number of ships placed on the @board" do
        expect { battleship.start_game }.to output(/25/).to_stdout
      end

      it "should printt the @board" do
        expect(battleship.board).to receive(:printt)
        battleship.start_game
      end
    end
    ...
    describe "#turn" do
      ...
      it "should printt the new number of @remaining_misses" do
        allow(battleship.player).to receive(:get_move).and_return([4, 2])
